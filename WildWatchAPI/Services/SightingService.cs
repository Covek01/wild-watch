    ...
    public class SightingService : ISightingService
    {
        ...
        public async Task DeleteAsync(string sightingId)
        {
            ...
            try
            {
                ...
                await _context.Sightings.DeleteOneAsync(sighting);
                await _context.Users.UpdateManyAsync(userSightingsFilter, userSightingsUpdate);
                await _context.Habitats.UpdateManyAsync(habitatSightingsFilter, habitatSightingsUpdate);
                await _context.Species.UpdateManyAsync(speciesSightingsFilter, speciesSightingsUpdate);
